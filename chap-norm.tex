...
\item values \bel{val}
\item and a predicate \bel{halts} to encode that a term halts if it steps into a value.
\end{itemize}
...
sometimes omitted in paper presentations.First, we prove that halts is closed under expansion in the \bel{halts_step} lemma.
