...
In \bel{mstep} we say that ever term steps to itself, and that you can
...
\improvement{Add the ``on paper'' definition here}
...
implicit argument. In the base case we appeal to \bel{halts_step}, while
in the \bel{Rarr} case we must also appeal to the induction hypothesis at
